...
exports.queue_cycle = 0;

// Real-time status
exports.rt_status = function() {
  return {
    cur_idx: exports.cur_idx,
    pending_fav: exports.pending_favored,
    favs: exports.favoreds,
    queue_cycle: exports.queue_cycle
  }
}
...
exports.next = function () {
  // console.log("queue_cycle = " + exports.queue_cycle + ", cur_idx = " + exports.cur_idx + ", queue.length = " + queue.length);
...
exports.add = function (/* ArrayBuffer */ buf, exec_ms, has_new_cov) {
  ...
  send({
    ...
    "exec_ms": exec_ms,
    "new_cov": has_new_cov,
    "stage": stages.rt_status(),
    "queue": exports.rt_status(),
    "map_rate": bitmap.map_rate,
  }, buf);
